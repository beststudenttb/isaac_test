...
NUM_ENVS = 32  # 与 arm A(drq_student)对齐;pipeline 也用 --num-envs 32。
...
IMAGE_SIZE = 224
FRAME_STACK = 1
CAPACITY_PER_ENV = 8192  # 与 arm A 对齐;8192 * 32 env * 224*224*3 uint8 ≈ 38GB(两条线并行约 76GB,机器 125GB)。
MIN_TIMEOUT_INTERVAL = 300
NSTEP = 3
DISCOUNT = 0.99
BATCH_SIZE = 256  # 与 arm A 对齐。
...
STDDEV_START = 0.3
STDDEV_END = 0.05  # 与 arm A 对齐(=STOP_EPS)。
