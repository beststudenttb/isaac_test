...
parser.add_argument("--out-dir", type=Path, default=Path("./data_shape"))
...
cfg = ScoreNoiseStudentEnvCfg()
cfg.seed = 13; cfg.episode_length_s = 1e5; cfg.stop_n = 1
...
CONDS = [
    # (条件名, 槽1, 槽2, 抬高 m)
    ("base",        ("ball1","red"),  ("ball2","blue"), 0.0),  # 基线,探针在此拟合
    # ---- 形状 ----
    ("red_cube",    ("cube","red"),   ("ball2","blue"), 0.0),  # 颜色对、形状错
    ("red_cone",    ("cone","red"),   ("ball2","blue"), 0.0),
    ("red_cyl",     ("cyl","red"),    ("ball2","blue"), 0.0),
    ("conflict",    ("ball1","blue"), ("cube","red"),   0.0),  # ★ 颜色 vs 形状对抗
    ("two_red_sh",  ("ball1","red"),  ("cube","red"),   0.0),  # ★ 两个都红,形状定偏好吗
    ("only_redcube",("cube","red"),   None,             0.0),
    ("only_blueball",None,            ("ball2","blue"), 0.0),
    ("grey_ball",   ("ball1","grey"), ("ball2","blue"), 0.0),
    ("blue_cube",   ("cube","blue"),  ("ball1","red"),  0.0),
    # ---- 距离线索:视觉大小 vs 接地点高度 ----
    ("scale_half",  ("ball_s","red"), ("ball2","blue"), 0.0),  # 半径 0.5r:大小减半,接地点不变
    ("scale_two",   ("ball_l","red"), ("ball2","blue"), 0.0),  # 半径 2r  :大小翻倍,接地点不变
    ("float_30",    ("ball1","red"),  ("ball2","blue"), 0.30), # 抬高 0.30m:接地点上移,大小不变
    ("float_60",    ("ball1","red"),  ("ball2","blue"), 0.60), # 抬高 0.60m
]
...
g = torch.Generator(device=dev); g.manual_seed(13)
