...
COMB=__import__("sys").argv[1]; ROOT=Path(f"models/vision/g4_{COMB}"); DATA=Path(f"./data_g4_{COMB}")
print(f"##### {COMB} #####",flush=True)
...
for n_,rel in [("A","A/donor.pt"),("V","V/donor.pt"),("R","R/donor.pt"),("sup","sup/donor.pt"),("init","encoder_init.pt")]:
    p=ROOT/rel
