"""Fixed SPR-encoder visual student offline val config."""

from pathlib import Path


OUT_DIR = Path("./models/rl/spr_fixed_student")  # 与 train 对齐的输出目录。
...
SPR_PRETRAINED = True  # 与 train 对齐。
FREEZE_STEM_LAYERS = True  # 与 train 对齐。
